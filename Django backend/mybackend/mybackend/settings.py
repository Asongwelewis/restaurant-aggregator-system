...
SECRET_KEY = 'django-insecure-iofy9dd4*2&@jpfqpjj$z75idt$w(vu#1ibns9!dke#c124%11'
...
LOGOUT_REDIRECT_URL = '/callback/'  # Redirect URL after login
LOGIN_REDIRECT_URL = '/callback/'  # Redirect URL after logout
SOCIALACCOUNT_PROVIDERS = {
    'google': {
        ...
        'FETCH_USERINFO': True,  # Fetch user info
    }
}

SOCIALACCOUNT_STORE_TOKEN = True  # Store the token in the database